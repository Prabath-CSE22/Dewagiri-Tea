...
const StatCard = ({ title, value, change, positive }) => (
    <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 w-full border border-gray-200">
      {/* Title */}
