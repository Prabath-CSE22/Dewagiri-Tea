...
const ViewProduct = ({product_id, isViewClicked, setIsViewClicked}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
      ...
      <div className="bg-gray-50 rounded-lg shadow-md p-8 sm:h-full">
        <div className="max-w-full mx-auto h-full flex flex-col">
          <h2 className="text-2xl font-bold mb-8 text-center">{formData.name}</h2>
              ...
              <div>
                ...
                <input type="text"
                    className={`w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
                        ...
                        ? 'text-green-800 border-green-300 focus:ring-green-500'
                        : 'text-yellow-800 border-yellow-300 focus:ring-yellow-500'
                    }`}
